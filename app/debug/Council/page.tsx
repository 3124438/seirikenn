    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="max-w-4xl mx-auto p-4 pb-32">
        <div className="mb-6 border-b border-gray-700 pb-4">
          <h1 className="text-2xl font-bold text-red-500 mb-4">生徒会 (Full Access)</h1>
          ...
          <details className="bg-gray-800 rounded-lg p-4 border border-gray-700 mb-4" open={isEditing}>
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                  ...
                  <div className="grid gap-2 md:grid-cols-3 mb-2">
                      ...
                      />
                      <input className="bg-gray-700 p-2 rounded text-white" placeholder="会場名 (例: お化け屋敷)" value={newName} onChange={e => setNewName(e.target.value)} />
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col items-start min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        {shop.department && (
                                            <span className="text-xs text-blue-300 font-bold border-l border-gray-600 pl-2">
                                                {shop.department}
                                            </span>
                                        )}
                                    </div>
                    ...
                    <div className="bg-gray-700 p-4 flex justify-between items-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex-1">
                            {targetShop.department && (
                                <span className="text-[10px] font-bold bg-blue-500 text-white px-2 py-0.5 rounded mb-1 inline-block border border-blue-400">
                                    {targetShop.department}
                                </span>
                            )}
